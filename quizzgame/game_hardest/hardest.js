document.addEventListener("DOMContentLoaded", async () => {
    ...
    const changeButton = document.getElementById('change-category-btn');
    changeButton.addEventListener('click', changeCategory);
    ...
    function showTimeoutScreen() {
        ...
        document.getElementById('change-category-btn').classList.remove('hide')  ;     
        questionElement.innerHTML = "<h2 id='time-message'>Aika loppui!</h2>";
        const timeMessage = document.getElementById('time-message');
        timeMessage.style.fontSize = '24px';
        timeMessage.style.marginBottom = '10px';
        answerButtonsElement.innerHTML = '';
        clockElement.classList.add('hide');
        pauseButton.classList.add('hide');
    
        const timeScreenScore = document.getElementById('score');
        timeScreenScore.classList.add('time-screen-score');
    }
    ...
    function changeCategory() {
        ...
        currentQuestionIndex = 0;
        clearInterval(clockInterval);
        document.getElementById("pauseOverlay").style.display = "none"; // Piilottaa pause-näkymän
    ...
    const scoreElement = document.getElementById('score');
        if (scoreElement) {
            ...
            scoreElement.classList.remove('time-screen-score'); 
        }
    }
